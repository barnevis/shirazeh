...
این افزونه یک آیکون قابل کلیک در کنار عنوان‌ها صفحه (h2, h3, ...) اضافه می‌کند که به کاربران اجازه می‌دهد لینک مستقیم به آن بخش را کپی کنند. برای اطلاعات بیشتر به **[مستندات افزونه لینک عنوان‌ها](./plugins/headingAnchor.md)** مراجعه کنید.

### افزونه رنگ‌آمیزی کد (Syntax Highlighting)
این افزونه با استفاده از کتابخانه قدرتمند Highlight.js، بلوک‌های کد شما را به صورت خودکار رنگ‌آمیزی می‌کند و قابلیت‌های پیشرفته‌ای مانند شماره خط و هایلایت خطوط خاص را فراهم می‌آورد. برای اطلاعات کامل به **[مستندات افزونه رنگ‌آمیزی کد](./plugins/highlight.md)** مراجعه کنید.
