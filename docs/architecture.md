...
│   │   ├── domRenderer.js
│   │   ├── fileReader.js
│   │   ├── layoutManager.js   # ماژول جدید مدیر چیدمان
│   │   ├── pageManager.js     # ماژول جدید مدیر صفحه
│   │   ├── parserManager.js
│   │   ├── pluginManager.js
│   │   ├── router.js
│   │   ├── sidebar.js
...
-   **`layoutManager.js`:** **مدیر چیدمان.** این ماژول جدید تمام وظایف مربوط به ساختار DOM را بر عهده دارد. مسئولیت ساخت چیدمان اصلی، هدر سایدبار، دکمه‌ها و تنظیم Favicon با این ماژول است.
...
4. app.js با تنظیمات نهایی، تمام مدیران اصلی (Layout, Theme, Parser, Page, etc.) را مقداردهی اولیه می‌کند
       |
       v
5. layoutManager.js ساختار اصلی HTML (سایدبار، محتوا و...) را در DOM ایجاد می‌کند
       |
       v
6. themeManager.js تم (روشن/تاریک) و فونت‌ها را اعمال می‌کند
       |
       v
7. parserManager.js مفسر مارک‌داون را بارگذاری می‌کند
       |
       v
8. sidebar.js محتوای منو را بارگذاری و رندر می‌کند
       |
       v
9. router.js مقداردهی اولیه شده و مسیر فعلی را می‌خواند
       |
       v
10. router.js به pageManager.js اطلاع می‌دهد که صفحه مربوطه را بارگذاری کند
        |
        v
11. pageManager.js:
