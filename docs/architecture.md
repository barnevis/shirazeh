...
-   **`app.js`:** ارکستراتور اصلی برنامه. این ماژول ساختار HTML را ایجاد کرده، تمام ماژول‌ها را هماهنگ و چرخه حیات برنامه را مدیریت می‌کند. همچنین مسئولیت تشخیص URLهای خارجی و بازنویسی لینک‌های داخلی آن‌ها را بر عهده دارد.
