...
**PWiki** یک راهکار مدرن برای ساخت ویکی، مستندات و وب‌سایت‌های محتوا-محور است که **بدون نیاز به سرور** و هیچ‌گونه فرآیند ساخت (build) کار می‌کند. تمام پردازش‌ها در مرورگر کاربر انجام می‌شود و محتوای شما به صورت فایل‌های مارک‌داون ساده مدیریت می‌شود.
...
-   **[معماری پروژه](./docs/architecture.md)**: آشنایی با ساختار فنی PWiki.
